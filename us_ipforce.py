...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Run investigation wave-29 NVIDIA-accelerated consolidated "
            "hypergraph of all sealed findings"
        ),
    )
    parser.add_argument(
        "--investigate-wave30",
        action="store_true",
        help=(
            "Run investigation wave-30 top-10 prosecutorial insights + "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Run investigation wave-32 follow all money flows and all "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Run investigation wave-34 NFT inventory + trace all linked "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Run investigation wave-36 NVIDIA full acceleration stack "
    ...
    if args.investigate_wave29:
        from us_ipforce_investigation_wave29 import main as wave29_main

        return int(wave29_main(["--print-report"] if args.print_report else []))

    if args.investigate_wave30:
        from us_ipforce_investigation_wave30 import main as wave30_main

        return int(wave30_main(["--print-report"] if args.print_report else []))

    if args.investigate_wave31:
        from us_ipforce_investigation_wave31 import main as wave31_main

        return int(wave31_main(["--print-report"] if args.print_report else []))

    if args.investigate_wave32:
