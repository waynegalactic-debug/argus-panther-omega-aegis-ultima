...
ENGINE_REGISTRY: list[dict[str, Any]] = [
    ...
    {
        "id": "investigation_wave24",
        "tier": "investigation",
        "weight": 83,
        "depends_on": ["investigation_wave23"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave24",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave25",
        "tier": "investigation",
        "weight": 82,
        "depends_on": ["investigation_wave24"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave25",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave26",
        "tier": "investigation",
        "weight": 81,
        "depends_on": ["investigation_wave25"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave26",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave27",
        "tier": "investigation",
        "weight": 80,
        "depends_on": ["investigation_wave26"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave27",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave28",
        "tier": "investigation",
        "weight": 79,
        "depends_on": ["investigation_wave27"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave28",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave29",
        "tier": "investigation",
        "weight": 78,
        "depends_on": ["investigation_wave28"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave29",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave30",
        "tier": "investigation",
        "weight": 77,
        "depends_on": ["investigation_wave29"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave30",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave31",
        "tier": "investigation",
        "weight": 76,
        "depends_on": ["investigation_wave30"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave31",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave32",
        "tier": "investigation",
        "weight": 75,
        "depends_on": ["investigation_wave31"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave32",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave33",
        "tier": "investigation",
        "weight": 74,
        "depends_on": ["investigation_wave32"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave33",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave34",
        "tier": "investigation",
        "weight": 73,
        "depends_on": ["investigation_wave33"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave34",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave35",
        "tier": "investigation",
        "weight": 72,
        "depends_on": ["investigation_wave34"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave35",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave36",
        "tier": "investigation",
        "weight": 71,
        "depends_on": ["investigation_wave35"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave36",
        "args": [],
        "verified_mode_required": False,
    },
    {
        "id": "investigation_wave37",
        "tier": "investigation",
        "weight": 70,
        "depends_on": ["investigation_wave36"],
        "parallel_group": "B",
        "kind": "python_main",
        "module": "us_ipforce_investigation_wave37",
        "args": [],
        "verified_mode_required": False,
    },
]
